...
PKG_CONFIG= sqlite3 glew glfw3 glu gl
...
OBJS= \
	...
	$(OBJ_DIR)/ChunkDB.o \
	$(OBJ_DIR)/ProcGen.o \
	$(OBJ_DIR)/MainEngine.o \
	$(OBJ_DIR)/RenderEngine.o \
	$(OBJ_DIR)/main.o \
	$(OBJ_DIR)/imgui/imgui.o \
	$(OBJ_DIR)/imgui/imgui_demo.o \
	$(OBJ_DIR)/imgui/imgui_draw.o \
	$(OBJ_DIR)/imgui/imgui_impl_glfw.o \
	$(OBJ_DIR)/imgui/imgui_impl_opengl3.o \
	$(OBJ_DIR)/imgui/imgui_widgets.o
